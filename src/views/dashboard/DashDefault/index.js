        ...
        <React.Fragment>
            <Row>
                ...
                <Col md={6} xl={8}>
                    <Card>
                        <Card.Header>
                            <Card.Title as="h5">Статистика</Card.Title>
                        </Card.Header>
                        <Card.Body>
                        ...
                        <Card.Body style={{ padding: '0 25px' }}>
                            <div className="earning-text mb-0">
                                <h3 className="mb-2 text-white f-w-300">
                                    {' '}
                                    86% <i className="feather icon-arrow-up teal accent-3" />
                                </h3>
                                <span className="text-uppercase text-white d-block">Общий процент выполнения</span>
                            </div>
                        ...
                        <Card.Body className="border-bottom">
                            <div className="row d-flex align-items-center">
                                ...
                                <div className="col">
                                    ...
                                    <span className="d-block text-uppercase">Всего идей</span>
                                </div>
                            </div>
                        </Card.Body>
                        {/* <Card.Body>
                ...
                <Col md={6} xl={4}>
                    <Card>
                        <Card.Header>
                            <Card.Title as="h5">Рейтинг</Card.Title>
                        </Card.Header>
                        <Card.Body>
